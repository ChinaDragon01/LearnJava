 ...
 * *******************************************************
 * Author: chinadragon
 * Time: 2020/12/17 下午6:16
 * Name:
 * Overview:
 *      各种经纬度坐标系转换-百度坐标系、火星坐标系、国际坐标系
 *      https://blog.csdn.net/lp840312696/article/details/83616144
 *
 *      各种经纬度坐标系转换-百度坐标系、火星坐标系、国际坐标系
...
public class PositionUtil {
    ...
    public static Gps Mars2Baidu(double gg_lat, double gg_lon){
        Point b = new Point();
        double x = gg_lon;
        double y= gg_lat;
    ...
    public static void main(String[] args) {
        ...
        // 121.425908,31.228153

        // 北斗定位坐标系 20006=A,3111.7140,12135.4276

        // 20006=A,3118.3875,12129.3035
